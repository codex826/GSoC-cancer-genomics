...
A list of cBioPortal GSoC project ideas are [available on GitHub with label GSoC-2026](https://github.com/cBioPortal/GSoC/issues?q=is%3Aopen+is%3Aissue+label%3AGSoC-2026). If you have any questions about any of the ideas, please comment in the issues on GitHub or ask us on the [cBioPortal Public Slack](https://slack.cbioportal.org).
...
- [A list of GSoC project ideas](https://github.com/cBioPortal/GSoC/issues?q=is%3Aopen+is%3Aissue+label%3AGSoC-2026)
- [Template proposal](https://github.com/cBioPortal/GSoC/wiki/Template)

## Previous GSoC Projects

- [GSoC 2025 Wrap-up](https://summerofcode.withgoogle.com/archive/2025/organizations/cbioportal-for-cancer-genomics#projects-list)
